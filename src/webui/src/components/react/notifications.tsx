...
// w-11 (2.75rem/44px) creates proper pill shape with 2.2:1 width-to-height ratio
const TOGGLE_BASE_CLASSES = "relative inline-flex h-5 w-11 flex-shrink-0 items-center rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-zinc-900";
